...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['name' => '1/2 Pollo a la Brasa', 'category' => 'pollos', 'description' => 'Ideal para compartir.', 'price' => 34.90, 'image_url' => '/images/products/pollos/medio.jpg'],
            ['name' => 'Pollo Entero a la Brasa', 'category' => 'pollos', 'description' => 'Con papas familiares y cremas.', 'price' => 64.90, 'image_url' => '/images/products/pollos/entero.jpg'],
            ...
            ['name' => 'Parrilla Mixta', 'category' => 'parrillas', 'description' => 'Churrasco, chorizo, anticucho y papas.', 'price' => 46.90, 'image_url' => '/images/products/parrillas/parrilla-mixta.jpg'],
            ...
            ['name' => 'Churrasco a la Parrilla', 'category' => 'parrillas', 'description' => 'Lomo a la parrilla con guarnicion.', 'price' => 36.90, 'image_url' => '/images/products/parrillas/churrasco.jpg'],
            ...
            ['name' => 'Brochetas de Pollo', 'category' => 'parrillas', 'description' => 'Brochetas con vegetales grillados.', 'price' => 27.90, 'image_url' => '/images/products/parrillas/brochetas.jpg'],
            ...
            ['name' => 'Chicha Morada 1L', 'category' => 'bebidas', 'description' => 'Chicha morada artesanal.', 'price' => 12.90, 'image_url' => '/images/products/bebidas/chicha.jpg'],
            ['name' => 'Maracuya Frozen', 'category' => 'bebidas', 'description' => 'Refrescante bebida frozen.', 'price' => 9.90, 'image_url' => '/images/products/bebidas/maracuya.jpg'],
